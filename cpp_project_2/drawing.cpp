...
int main(int argc, char **argv) {
  ...
  // Sets the loop rate to 10 cycles per second
    ...
    float coordinates [50][2] = {{6.5,5.45},{6.5,6.5},{5.5,6.5},{5.45,5.45},//square one
                                 {5.47,5},{6.5,5},{6.49,3},{5.5,3},{5.45,5},//teleport to square two (5.5,5)
                                 {4.5,7},{6.75,7},{7.25,6.5},
                                 {7.27,5.75},//teleport to B (4.5,7)
                                 {6.75,5.25},{7.25,4.75},{7.27,4}, {6.75,3.5},//
                                 {4.5,3.5},{5,4},{5.2,6.5},{4.5,7},//
                                 {4,7.5},{7.75,7.5},{7.78,3.5},{6,2.5},
                                 {4,3.5},{4,7.5}};//teleport to shield*/
